%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% PURPOSE: Runs Bellman recursion for a particular scenario and
% configuration.
% INPUT:
...
function[] = Run_Bellman_Recursion(scenarioID, configurationID)
    ...
    if isfile(complete_file) 
        disp(strcat(['Bellman recursion is already complete for scenario ', scenarioID, ' under configuration ', mat2str(configurationID)]));
        return; 
    end
