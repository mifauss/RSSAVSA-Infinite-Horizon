...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function[V_alphas, real_coordinates] = Run_Outer_Optimization_MPC(scenarioID, start_configID, end_configID, alphas, configIDvec)
    ...
    % allows some configs in start_configID : end_configID to be run
    for configurationID = configIDvec
