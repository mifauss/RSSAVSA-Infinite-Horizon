...
function Plot_Infinte_Horizon_Figure2(j,N)

    staging_area = get_staging_directory('', '');
    %outer_optimization_file = strcat([staging_area,'outer_optimization.mat']);
    outer_optimization_file = strcat([staging_area,'outer_optimization_','j_', num2str(j), '.mat']);
    ...
    title(['Baseline: $\alpha$ = ', num2str(alpha), ', $N$ = ', num2str(N)], 'Interpreter','Latex', 'FontSize', 12);
