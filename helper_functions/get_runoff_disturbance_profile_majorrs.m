...
function [ws, P, nw, wunits] = get_runoff_disturbance_profile_majorrs(type)
    ...
    switch type 
        ...
        case 'uniform'
            ws = [1.00;2.00;2.50;3.00;3.50;4.00;4.49;5.00;5.50;6.00;7.00];   
            P = [0.002064709, 0.026525218, 0.064847303, 0.122841965, 0.180311528, 0.205079441, 0.180735162, 0.123419867, 0.065305445, 0.026775378, 0.002093986]; 
